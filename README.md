...
2. Start Chrome with remote debugging enabled:
   ...
   You can use the included script which automatically detects your OS and starts Chrome with the correct command:
   ```bash
...
- SSE endpoint: `http://localhost:3000/sse-cursor`
